...
private:
    ...
    bool isPaused;  // Nouvel état de pause
...
public:
    ...
    void handleEvents() {
        ...
        while (window.pollEvent(event)) {
            ...
            if (event.type == sf::Event::KeyPressed) {
                ...
                else if (event.key.code == sf::Keyboard::P && !gameOver) {  // Nouvelle touche pour la pause
                    isPaused = !isPaused;
                    if (isPaused) {
    ...
    void render() {
        ...
        drawText(window, "Click: Place tower (50 gold) | Click on tower: Upgrade | SPACE: Start wave | A: Audio controls | P: Pause", 
