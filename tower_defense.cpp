...
private:
    ...
    TowerType selectedTowerType = TowerType::BASIC; // Added for tower selection
...
public:
    ...
    void handleEvents() {
        ...
        while (window.pollEvent(event)) {
            ...
            // Stop handling game events if game is over
            if (lives <= 0 || wave > 10) {
                continue;
            }
            ...
            if (event.type == sf::Event::KeyPressed) {
                ...
                if (event.key.code == sf::Keyboard::Num1) selectedTowerType = TowerType::BASIC;
                if (event.key.code == sf::Keyboard::Num2) selectedTowerType = TowerType::SNIPER;
                if (event.key.code == sf::Keyboard::Num3) selectedTowerType = TowerType::CANNON;
                if (event.key.code == sf::Keyboard::Num4) selectedTowerType = TowerType::FREEZE;
            }
